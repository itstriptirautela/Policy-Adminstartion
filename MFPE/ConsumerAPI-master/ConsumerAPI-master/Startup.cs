...
namespace ConsumerMicroservice
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IConsumerBusinessRepo, ConsumerBusinessRepo>();
            services.AddDbContext<ConsumerContext>(item => item.UseSqlServer(Configuration.GetConnectionString("TestConnectionString")));
