...
namespace ConsumerMicroserviceTests
{
    ...
    {
        private Mock<IConsumerRepo> consumerMock;
        private Mock<IConsumerBusinessRepo>cosumerBusinessMock;
        private Mock<IPropertyRepo>businessPropertyMock;
        ...
        public void Setup()
        {
            consumerMock = new Mock<IConsumerRepo>();
            cosumerBusinessMock = new Mock<IConsumerBusinessRepo>();
            businessPropertyMock = new Mock<IPropertyRepo>();
